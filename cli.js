...
const { uploadFile, listFiles } = require("./src/drive/drivefunct.js");

const initializer = require("./src/commands/initializer.js");

console.log(figlet.textSync("Kraken Art VCS"));

program.version("1.0.0").description("Kraken Art Version Control System");

// Initialize Version Control System
program
    .command("init")
    .description(
        "Initialize a new Kraken Art Version Control System repository"
    )
    .option("-f, --force", "Force initialization")
    .action((options) => initializer(options));
...
program
    ...
    .action(() => {
        ...
        inquirer.prompt(questions).then((answers) => {
            console.log(
                `Artwork Added: Title - ${answers.title}, Description - ${answers.description}`
            );
